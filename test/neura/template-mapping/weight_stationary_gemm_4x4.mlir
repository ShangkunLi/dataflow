...
// BOUNDS: memory_access element offset is out of bounds
...
module {
  func.func @ws_gemm_3x3(%A: memref<3x3xi32>, %B: memref<3x3xi32>, %C: memref<3x3xi32>) {
    ...
    ^bb0(%a: memref<3x3xi32>, %b: memref<3x3xi32>, %c: memref<3x3xi32>):
      %a0 = "neura.load"() {memory_access = {kernel_input = 0 : i32, offsets = array<i64: 0, 3, 6>}, placement = {x = 0 : i32, y = 3 : i32}} : () -> i32
      ...
      %a1 = "neura.load"() {memory_access = {kernel_input = 0 : i32, offsets = array<i64: 1, 4, 7>}, placement = {x = 0 : i32, y = 2 : i32}} : () -> i32
      ...
      %a2 = "neura.load"() {memory_access = {kernel_input = 0 : i32, offsets = array<i64: 2, 5, 8>}, placement = {x = 0 : i32, y = 1 : i32}} : () -> i32
      ...
      "neura.store"(%m_1_1#0) {memory_access = {kernel_input = 2 : i32, offsets = array<i64: 0, 3, 6>}, placement = {x = 1 : i32, y = 0 : i32}} : (i32) -> ()
      "neura.store"(%m_2_1#0) {memory_access = {kernel_input = 2 : i32, offsets = array<i64: 1, 4, 7>}, placement = {x = 2 : i32, y = 0 : i32}} : (i32) -> ()
      "neura.store"(%m_3_1#0) {memory_access = {kernel_input = 2 : i32, offsets = array<i64: 2, 5, 8>}, placement = {x = 3 : i32, y = 0 : i32}} : (i32) -> ()
      neura.yield
    }
    return
  }
...
// MAPPING-NEXT:       %0 = "neura.load"() {dfg_id = 0 : i32, mapping_locs = [{id = 12 : i32, index_per_ii = 0 : i32, invalid_iterations = 0 : i32, resource = "tile", time_step = 0 : i32, x = 0 : i32, y = 3 : i32}], memory_access = {kernel_input = 0 : i32, offsets = array<i64: 0, 3, 6>}} : () -> !neura.data<i32, i1>
...
// MAPPING-NEXT:       %4 = "neura.load"() {dfg_id = 1 : i32, mapping_locs = [{id = 8 : i32, index_per_ii = 0 : i32, invalid_iterations = 1 : i32, resource = "tile", time_step = 1 : i32, x = 0 : i32, y = 2 : i32}], memory_access = {kernel_input = 0 : i32, offsets = array<i64: 1, 4, 7>}} : () -> !neura.data<i32, i1>
...
// MAPPING-NEXT:       %11 = "neura.load"() {dfg_id = 2 : i32, mapping_locs = [{id = 4 : i32, index_per_ii = 0 : i32, invalid_iterations = 2 : i32, resource = "tile", time_step = 2 : i32, x = 0 : i32, y = 1 : i32}], memory_access = {kernel_input = 0 : i32, offsets = array<i64: 2, 5, 8>}} : () -> !neura.data<i32, i1>
...
// MAPPING-NEXT:       "neura.store"(%18) {dfg_id = 24 : i32, mapping_locs = [{id = 1 : i32, index_per_ii = 0 : i32, invalid_iterations = 4 : i32, resource = "tile", time_step = 4 : i32, x = 1 : i32, y = 0 : i32}], memory_access = {kernel_input = 2 : i32, offsets = array<i64: 0, 3, 6>}} : (!neura.data<i32, i1>) -> ()
...
// MAPPING-NEXT:       "neura.store"(%19) {dfg_id = 30 : i32, mapping_locs = [{id = 2 : i32, index_per_ii = 0 : i32, invalid_iterations = 5 : i32, resource = "tile", time_step = 5 : i32, x = 2 : i32, y = 0 : i32}], memory_access = {kernel_input = 2 : i32, offsets = array<i64: 1, 4, 7>}} : (!neura.data<i32, i1>) -> ()
...
// MAPPING-NEXT:       "neura.store"(%20) {dfg_id = 33 : i32, mapping_locs = [{id = 3 : i32, index_per_ii = 0 : i32, invalid_iterations = 6 : i32, resource = "tile", time_step = 6 : i32, x = 3 : i32, y = 0 : i32}], memory_access = {kernel_input = 2 : i32, offsets = array<i64: 2, 5, 8>}} : (!neura.data<i32, i1>) -> ()
...
// ASM-NEXT: PE(1,0):
// ASM-NEXT: {
// ASM-NEXT:   STORE, [NORTH, RED], [address(arg2, 0, 3, 6)] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(2,0):
// ASM-NEXT: {
// ASM-NEXT:   STORE, [NORTH, RED], [address(arg2, 1, 4, 7)] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(3,0):
// ASM-NEXT: {
// ASM-NEXT:   STORE, [NORTH, RED], [address(arg2, 2, 5, 8)] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(0,1):
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [address(arg0, 2, 5, 8)] -> [EAST, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(1,1):
// ASM-NEXT: {
// ASM-NEXT:   MUL_ADD, [WEST, RED], [value(arg1, 6)], [NORTH, RED] -> [SOUTH, RED] (t=0, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(2,1):
// ASM-NEXT: {
// ASM-NEXT:   MUL_ADD, [WEST, RED], [value(arg1, 7)], [NORTH, RED] -> [SOUTH, RED] (t=0, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(3,1):
// ASM-NEXT: {
// ASM-NEXT:   MUL_ADD, [WEST, RED], [value(arg1, 8)], [NORTH, RED] -> [SOUTH, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(0,2):
// ASM-NEXT: {
// ASM-NEXT:   LOAD, [address(arg0, 1, 4, 7)] -> [EAST, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(1,2):
// ASM-NEXT: {
// ASM-NEXT:   MUL_ADD, [WEST, RED], [value(arg1, 3)], [NORTH, RED] -> [SOUTH, RED] (t=0, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(2,2):
// ASM-NEXT: {
// ASM-NEXT:   MUL_ADD, [WEST, RED], [value(arg1, 4)], [NORTH, RED] -> [SOUTH, RED] (t=0, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(3,2):
// ASM-NEXT: {
// ASM-NEXT:   MUL_ADD, [WEST, RED], [value(arg1, 5)], [NORTH, RED] -> [SOUTH, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(0,3):
// ASM-NEXT: {
...
// ASM-NEXT: PE(1,3):
// ASM-NEXT: {
// ASM-NEXT:   MUL, [WEST, RED], [value(arg1, 0)] -> [SOUTH, RED] (t=0, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(2,3):
// ASM-NEXT: {
// ASM-NEXT:   MUL, [WEST, RED], [value(arg1, 1)] -> [SOUTH, RED] (t=0, inv_iters=0)
// ASM-NEXT:   DATA_MOV, [WEST, RED] -> [EAST, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
// ASM-EMPTY:
// ASM-NEXT: PE(3,3):
// ASM-NEXT: {
// ASM-NEXT:   MUL, [WEST, RED], [value(arg1, 2)] -> [SOUTH, RED] (t=0, inv_iters=0)
// ASM-NEXT: } (idx_per_ii=0)
